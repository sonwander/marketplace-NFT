...
contract Marketplace is ReentrancyGuard {
    ...
    function makeItem(IERC721 _nft, uint _tokenId, uint _price) external nonReentrant {
        ...
        // Ensure the caller has approved this contract to transfer their NFT
        require(_nft.getApproved(_tokenId) == address(this), "Contract not approved to transfer NFT");
